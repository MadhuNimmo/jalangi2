...
function getTypeMetric() {
        ...
        var frm_cnt=0;
                ...
                var tot_avg_precision= tot_precision ==0? 0: (tot_precision/key_cnt).toFixed(4)
                var tot_avg_recall= tot_recall ==0? 0: (tot_recall/key_cnt).toFixed(4)
                var app_avg_precision= app_precision ==0? 0: (app_precision/app_cnt).toFixed(4)
                var app_avg_recall= app_recall ==0? 0: (app_recall/app_cnt).toFixed(4)
                var frm_avg_precision= frm_precision ==0? 0: (frm_precision/frm_cnt).toFixed(4)
