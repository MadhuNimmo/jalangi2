...
function getTypeMetric() {
        ...
        var COM_frmnodes=[]
                ...
                tot_precision = (COM_nodes.length == 0 ? 0: COM_nodes.length/SCG_nodes.length).toFixed(4);
                tot_recall = (COM_nodes.length == 0? 0: COM_nodes.length/DCG_nodes.length).toFixed(4);
                ...
                app_precision = (COM_appnodes.length == 0 ? 0: COM_appnodes.length/SCG_appnodes.length).toFixed(4);
                app_recall = (COM_appnodes.length == 0? 0: COM_appnodes.length/DCG_appnodes.length).toFixed(4);

                frm_precision = (COM_frmnodes.length == 0 ? 0: COM_frmnodes.length/SCG_frmnodes.length).toFixed(4);
                frm_recall = (COM_frmnodes.length == 0? 0: COM_frmnodes.length/DCG_frmnodes.length).toFixed(4);*/
