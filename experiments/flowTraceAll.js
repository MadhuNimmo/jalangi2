        ...
        J$.analysis = {
                ...
                literal: function (iid, val, hasGetterSetter) {
                    if(typeof val== 'function'){
                        ...
                        if(lstKeys.indexOf(getLoc("literal",J$.getGlobalIID(iid))) > -1 || J$.ast_info.length == 0){
                ...
                invokeFun: function (iid, f, base, args, result, isConstructor, isMethod, functionIid, functionSid) {
                    ...
                    else if(list!==null && lst.indexOf(list[0]["retId"]) > -1 || J$.ast_info.length == 0 ){
                        addToTrace("InvokeReturn",funName,funId,getLoc("invkretrn",J$.getGlobalIID(iid)),list)
            ...
            endExecution: function () {
                if (!isBrowser) {
                    ...
                    //console.log(json)
                    filename=(process.argv[1]).replace(/.js$/,"_traceAll.json");
