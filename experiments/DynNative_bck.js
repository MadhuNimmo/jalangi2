        ...
        J$.analysis = {
                ...
                invokeFunPre: function (iid, f, base, args, isConstructor, isMethod, functionIid, functionSid) {
                        ...
                        if ((f.toString().indexOf('[native code]') > -1 || f.toString().indexOf('[object ') === 0)) {
                                ...
                                callerIid = "'" + iidToFunName[callStack[callStack.length - 1]] + "' " + getLoc(giid);
                ...
                functionEnter: function (iid, f, dis, args) {
                        ...
                        if (iidToCallerLoc[giid] == undefined) {
                                ...
                                if (f.name.startsWith("set ") || f.name.startsWith("get ")){
                                        ...
                                        callerIid = "'" + callerName + "' " +getLoc(setterGetter[setterGetter.length - 1]);
                        ...
                        //Identifying Non-native -> Non-native Calls
                                ...
                                callerIid = "'" + callerName + "' " + getLoc(iidToCallerLoc[giid]);

                        }

                        calleeIid = "'" + iidToFunName[giid] + "' " + getLoc(giid);
                ...
                endExecution: function () {
                        ...
                        var jsonString = JSON.stringify(jsonCallList)
                        if (!isBrowser) {
...
/*
node src/js/commands/jalangi.js --inlineIID --inlineSource --analysis experiments/DynNative.js experiments/example.js
node src/js/commands/instrument.js --inlineIID --inlineSource -i --inlineJalangi --analysis src/js/sample_analyses/ChainedAnalyses.js --analysis src/js/sample_analyses/dlint/Utils.js --analysis experiments/DynNative.js --outputDir /tmp experiments/html/
