...
module.exports = (async () => {
  ...
  await Promise.race([
    page.goto("http://192.168.1.14:3000/index.html", { waitUntil: ["load", "networkidle2"] , timeout: 0}),
    page.waitFor("body"),
  ]);
  ...
  const searchSpace = await waitForAnySelector(page,['#mat-input-0'])
  ...
  await page.waitFor(2000)
  await page.waitForSelector('.mat-content > .ng-tns-c156-24')
  await page.click('.mat-content > .ng-tns-c156-24')
  await page.waitFor(2000)
  await page.waitForSelector('div > .mat-dialog-actions > .close-dialog > .mat-button-wrapper > span')
  await page.click('div > .mat-dialog-actions > .close-dialog > .mat-button-wrapper > span')
  await page.waitFor(5000)
  ...
  const pwdSpace = await waitForAnySelector(page,['#password'])
  await page.type(pwdSpace,"Xyz@1234")
  ...
  await page.waitForSelector('#mat-expansion-panel-header-2')
  ...
  await page.waitFor(3000)
  await page.waitForSelector('input#mat-input-19')
  await page.click('input#mat-input-19')
  await page.type('input#mat-input-19','someone')

  await page.waitForSelector('#mat-input-20')
  await page.click('#mat-input-20')
  await page.type('#mat-input-20',"1234123412341234")
  
  await page.waitForSelector('#mat-input-21')
  await page.type('#mat-input-21',"10")

  await page.waitForSelector('#mat-input-22')
  await page.type('#mat-input-22',"2081")
 ...
 //checkout
  ...
  await page.waitFor(2000)
  const [ordrHist] = await page.$x("//span[contains(., ' Order History ')]");
  if (ordrHist) {
  ...
  //await page.type('input[data-placeholder="...in liters"]',"10")
  
  //const savedAdd = await page.$x('/html/body/app-root/div/mat-sidenav-container/mat-sidenav-content/app-recycle/mat-card/div[1]/div/app-address/mat-card/mat-table/mat-row/mat-cell[1]/mat-radio-button')
  //['#mat-radio-38','#mat-radio-43'])
  ...
  await page.type('#mat-input-40','someoneelse')

  //await page.waitForSelector('#mat-input-18')
  await page.waitForSelector('#mat-input-41')
  await page.click('#mat-input-41')
  await page.type('#mat-input-41',"1234123412341235")
  
  //await page.waitForSelector('#mat-input-19')
  await page.waitForSelector('#mat-input-42')
  await page.type('#mat-input-42',"10")

  //await page.waitForSelector('#mat-input-20')
  await page.waitForSelector('#mat-input-43')
  await page.type('#mat-input-43',"2081")
  ...
  //await page.waitForSelector('#mat-input-21')
  await page.waitForSelector('#mat-input-44')
  await page.type('#mat-input-44',"40")
  
  await page.waitForSelector('#submitButton')
  await page.click('#submitButton')
  
  //await page.waitForSelector('#mat-radio-40')
  await page.waitForSelector('#mat-radio-45')
  ...
  //await page.waitForSelector('#mat-radio-42')
  await page.waitForSelector('#mat-radio-47')
  await page.click('#mat-radio-47')
  //fix me with captcha
  await page.waitForSelector('#submitButton')
  await page.click('#submitButton')
