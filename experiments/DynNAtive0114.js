(function () {
        ...
        J$.analysis = {
                ...
                scriptEnter: function (iid, instrumentedFileName, originalFileName) {
                        ...
                        //if (originalFileName!="evalIndirect"){//new study behavior
                                //callStack.push(giid);
                        //}
                },
                /**
                ...
                invokeFunPre: function (iid, f, base, args, isConstructor, isMethod, functionIid, functionSid) {
                        ...
                        //console.log(getLoc(giid),getLoc(functionSid+":"+functionIid))
                ...
                functionEnter: function (iid, f, dis, args) {
                        //console.log("FE",iid,f.name,callStack)
                        var funName = f.name;
                        var giid = J$.getGlobalIID(iid);
                        iidToFunName[giid] = funName == "" ? "anon" : funName;
                        //console.log(getValue(f,SPECIAL_PROP_IID,SPECIAL_PROP_SID))
