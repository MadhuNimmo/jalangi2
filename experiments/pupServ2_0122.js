...
const browser = await puppeteer.launch({headless: false,
 ...
 //page.setDefaultNavigationTimeout( 90000 ); //new
...
var getData = async() => {
  ...
  data = await getData().catch(error => console.log(`Error reading output: ${error}.`));
  await browser.close();
  server.close();
  var out="[";
