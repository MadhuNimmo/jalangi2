...
def test(prefix, file, rest):
    ...
    if status == 0:
        ...
        ana = sj.execute_return_np(sj.ANALYSIS_SCRIPT+'  --analysis ../src/js/sample_analyses/ChainedAnalyses.js --analysis ../experiments/func_call.js '+prefix+file+'_jalangi_.js '+rest, savestderr=True)
        if normal != ana:
            status = 1
