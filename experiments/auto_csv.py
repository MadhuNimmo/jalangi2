...
for results in os.listdir(target):
    if results.endswith('.json') and 'resultCount' in results:
        print('Loading json....')
        with open(os.path.join(target, results), "r") as framework_res_json:
